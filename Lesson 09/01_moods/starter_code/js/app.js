//wait for the DOM elements to load before executing
    ...
    function checkMood(e){
        ...
        if (moodvalue == "excited" || moodvalue == "ecstatic" || moodvalue == "fantastic"){
            document.querySelector(".moodring div").setAttribute("class", "excited"); // find a div and give it a class of excited
        }

        // if the user inputs happy/good/great change the CSS class to 'happy'

        if (moodvalue == "happy" || moodvalue == "good" || moodvalue == "great"){
            document.querySelector(".moodring div").setAttribute("class", "happy"); // find a div and give it a class of happy
        }

        // if the user inputs bad/angry change the CSS class to 'bad'

        if (moodvalue == "bad" || moodvalue == "angry"){
            document.querySelector(".moodring div").setAttribute("class", "bad"); // find a div and give it a class of bad
        }
    }
